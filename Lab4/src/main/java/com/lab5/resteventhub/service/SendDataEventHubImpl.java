...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("laboratorna-4")//namespace
                .setEventHubName("lab-4")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://laboratorna-4.servicebus.windows.net/;SharedAccessKeyName=lab;SharedAccessKey=Z/4VdKDklULkhzmcIwIxMEmb+TDMxoQ8QqrnSFqWgrE=")
                /*Primary key*/
                .setSasKey("Z/4VdKDklULkhzmcIwIxMEmb+TDMxoQ8QqrnSFqWgrE=");
