...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "lab-4.redis.cache.windows.net";
    private final static String CACHE_KEY = "5ToiqAHDyNPkSbbHv7eP3wPMtTnqAhKogZBRyCGHgdY=";
