...
/**
 * Criteria class for the {@link com.denysiuk.dental.domain.Procedure} entity. This class is used
 * in {@link com.denysiuk.dental.web.rest.ProcedureResource} to receive all the possible filtering options from
...
public class ProcedureCriteria implements Serializable, Criteria {
    ...
    private LongFilter treatmentsId;
    ...
    public ProcedureCriteria(ProcedureCriteria other) {
        ...
        this.treatmentsId = other.treatmentsId == null ? null : other.treatmentsId.copy();
    }
    ...
    public LongFilter getTreatmentsId() {
        return treatmentsId;
    }

    public void setTreatmentsId(LongFilter treatmentsId) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(treatmentsId, that.treatmentsId);
    }
    ...
    public String toString() {
        return "ProcedureCriteria{" +
                ...
                (treatmentsId != null ? "treatmentsId=" + treatmentsId + ", " : "") +
            "}";
    }
