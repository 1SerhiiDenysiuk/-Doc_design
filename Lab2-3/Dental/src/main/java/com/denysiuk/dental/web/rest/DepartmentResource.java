...
import com.denysiuk.dental.domain.Department;
import com.denysiuk.dental.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.denysiuk.dental.domain.Department}.
 */
@RestController
@RequestMapping("/api")
