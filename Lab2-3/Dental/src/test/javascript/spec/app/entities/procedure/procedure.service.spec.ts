...
describe('Service Tests', () => {
  describe('Procedure Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ProcedureService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Procedure(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Procedure', () => {
        ...
        service.create(new Procedure()).subscribe(resp => (expectedResult = resp.body));
